...
# do not edit this file to change configuration. Change the options in .env or set environment variables.
# see https://github.com/haileyydev/maildrop?tab=readme-ov-file#configuration for help configuring.
